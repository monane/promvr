...
Возможности расширения:
 ...
 - [В данных сегмента помимо цвета заложен и радиус кисти](Assets/_Main/Scripts/Drawing/DrawingSegment.cs#L11) - можно легко вывести на панель управления слайдер для настройки радиуса кисти.
...
- [APK-файл](https://disk.yandex.ru/d/jQZE-oUscVJ6Ag)
